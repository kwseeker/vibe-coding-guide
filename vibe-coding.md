...
- 计划
	智能体：丰富规格说明、任务单和依赖关系
	工程师：进行优先级排序、评估工作量并安排工作顺序
- 设计
	智能体：搭建项目结构和组件框架
	工程师：完善用户体验、架构设计和约束条件
-  构建
	智能体：实现功能、进行代码集成和问题修复
	工程师：指导代码行为、设计模式和权衡决策
- 测试
	智能体：基于代码和规格说明提出并更新测试用例
	工程师：验证测试覆盖率、边界条件和业务意图
- 评审
	智能体：对每个拉取请求进行初步代码审查
	工程师：负责最终审批以及架构质量的把控
- 文档
	智能体：生成摘要、技术文档和发布说明
	工程师：梳理项目叙事脉络，记录关键技术决策
- 部署与维护
	智能体：对日志、告警和可疑提交进行分类排查
	工程师：处理新颖、高风险或敏感的问题
